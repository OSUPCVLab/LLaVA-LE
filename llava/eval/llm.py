...
class GPT(LLM):
  ...
  # ============================================
  # TODO: CONFIGURE YOUR OPENAI API HERE
  # ============================================
  ...
  # Set USE_AZURE = False and provide OPENAI_API_KEY environment variable
  USE_AZURE = False  # Set to False for standard OpenAI
